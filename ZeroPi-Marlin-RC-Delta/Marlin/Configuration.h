...
// #define  DEFAULT_Kd 101.01
//#define  DEFAULT_Kp 17.15
//#define  DEFAULT_Ki 0.62
//#define  DEFAULT_Kd 158.10
...
//#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER -34.72     // Z probe to nozzle X offset: -left  +right
...
#define DEFAULT_X_ENDSTOP_ADJ 0//-5.0
#define DEFAULT_Y_ENDSTOP_ADJ  0//-4.5
#define DEFAULT_Z_ENDSTOP_ADJ 0//-5.4
...
// For deltabots this means top and center of the Cartesian print volume.
  ...
  #define MANUAL_Z_HOME_POS 345.2 // For delta: Distance between nozzle and print surface after homing.
#endif
...
// default settings
#define STEP_DRIVER_RESOLUTION  32      //set stepper resolution (1,2,4,8,16,32)
#define STEP_DRIVER_TYPE DRV8825        //stepper driver type (DRV8825,A4988,A4982)
